...
const AiAgentBubble = () => {
  ...
  return (
    <>
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-24 right-6 z-50 w-[360px] max-h-[500px] rounded-2xl border-2 border-primary/20 bg-card shadow-2xl flex flex-col animate-fade-in overflow-hidden">
          {/* Header */}
          <div className="flex items-center gap-3 px-4 py-3 bg-primary text-primary-foreground">
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] opacity-80">Your event planning assistant</p>
            </div>
